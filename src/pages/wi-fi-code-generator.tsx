...
export default function WifiCodeGeneratorPage() {
  return (
    <MainLayout {...HeaderProps}>
      <div className={styles.description}>
        wi-fi-qr-code-generator — это удобное и функциональное приложение, которое помогает владельцам автомобилей получать важные сведения о своем
